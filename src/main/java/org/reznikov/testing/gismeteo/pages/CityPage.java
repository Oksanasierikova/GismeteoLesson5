...
public class CityPage //extends GismeteoHomePage
{
    ...
    private static final String MONTH_VIEW_TAB = "//div[@class='wtitle h2']//a[@href='/weather-kharkiv-5053/month/']";
    //private static final String TWO_WEEKS_VIEW_TAB = "//*[@id='weather-daily']/div[3]/div[1]/a[4]";
    private static final String TWO_WEEKS_VIEW_TAB = "//div[@class='wtitle h2']//a[@class='2week']";
    private static final String TEMP_DAY = "//*[@id='tbwdaily1']/tr[3]/td[3]/span[1]";
   // private static final String TEMP_DAY = "//div[@class='wsection wdata'][.//tr[@class='wrow forecast']]//span[@class='value m_temp c']";
    private static final String TEMP_NIGHT = "//*[@id='tbwdaily1']/tr[1]/td[3]/span[1]";
    private static final String DAY_OF_WEEK = "//div[@class='wtabs wrap']//div[@class='wtab swtab']";
...
//    }
    ...
    public GetDate getDate(){
        wait.until((ExpectedConditions.visibilityOfElementLocated(By.xpath(DAY_OF_WEEK))));
        return new GetDate(driver);
    }
}
